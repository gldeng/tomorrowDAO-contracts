...
namespace TomorrowDAO.Contracts.Treasury
{
    ...
    public class Module : AElf.Testing.TestBase.ContractTestModule<TreasuryContract>
    {
    ...
    public class TestBase : AElf.Testing.TestBase.ContractTestBase<Module>
    {
        ...
        private void DeployVoteContract()
        {
            ...
            VoteContractStub =
                GetContractStub<VoteContractContainer.VoteContractStub>(VoteContractAddress, DefaultKeyPair);
        }
        ...
        private void DeployElectionContract()
        {
            ...
            ElectionContractStub =
                GetContractStub<ElectionContractContainer.ElectionContractStub>(ElectionContractAddress,
                    DefaultKeyPair);
        }
