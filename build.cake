...
var rootPath     = "./";
var srcPath      = rootPath + "contracts/*/src/";
var testPath     = rootPath + "contracts/*/test/";
var solution     = rootPath + "TomorrowDAOContracts.sln";
    ...
    .Does(() =>
{
    ...
    var testProjects = GetFiles("./contracts/*/test/*.csproj");
